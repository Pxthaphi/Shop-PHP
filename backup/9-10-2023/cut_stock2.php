                                            ...
                                            ?>
                                                ...
                                                <div class="card mx-2 my-2 text-center" style="width: 200px;">
                                                    ...
                                                    <div class="card-footer">
                                                        <a href="#" class="btn btn-danger" onclick="addToStockCutBox('<?= $result["Product_Name"]; ?>', <?= $result["Product_Qty"]; ?>, <?= $result["Product_ID"]; ?>)">ตัดสต็อกสินค้า</a>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                            ...
                            <div class="col-lg-5 pt-5">
                                <div class="row gy-3 mb-4">
                                    <form method="POST" onsubmit="return validateForm();">
                                        ...
                                        <button type="submit" class="btn btn-success w-100 shadow-0 mb-2" id="cutStockButton" name="cut_stock">ตัดสต็อกสินค้า</button>
        ...
        if ($queryHistory) {
            ...
            foreach ($selectedProducts as $productName => $productData) {
                ...
                $sqlHistoryProduct = "INSERT INTO history_product (History_ID, Pro_ID, Username, Product_Qty) 
                                        VALUES ('$historyID', '$productID', '$username', '$quantityToCut')";
