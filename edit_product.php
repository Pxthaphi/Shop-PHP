...
<head>
  <title>แก้ไขข้อมูลสินค้า | ร้านมาลีวัลย์สังฆภัณฑ์</title>
                ...
                <div class="card-content">
                  <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="Product_ID" placeholder="xxxxxxxxx" aria-label="xxxxxxxxx" aria-describedby="ProductID" required />
                      </div>
                  </div> -->
                  <div class="row mb-4">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">ชื่อสินค้า</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Product_Name" value="<?= $result['Product_Name']; ?>" placeholder="กรุณาใส่ชื่อสินค้า" aria-label="กรุณาใส่ชื่อสินค้า" aria-describedby="basic-icon-default-fullname2" required />
                    </div>
                  </div>
                  <div class="row mb-4">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Product_Price" value="<?= $result['Product_Price']; ?>" placeholder="กรุณาใส่ราคาสินค้า" aria-label="กรุณาใส่ราคาสินค้า" aria-describedby="basic-icon-default-fullname2" required />
                    </div>
                  </div>
                  <div class="row mb-4">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">จำนวนสินค้า</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Product_Qty" value="<?= $result['Product_Qty']; ?>" placeholder="กรุณาใส่จำนวนสินค้า" aria-label="กรุณาใส่จำนวนสินค้า" aria-describedby="basic-icon-default-fullname2" required />
                    </div>
                  </div>
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="file" name="edit_uploaded" class="form-control" accept="image/jpeg" onchange="loadFile(event)">
                    </div>
                  </div>
                  <div class="row mb-4">
