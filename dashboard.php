...
<html lang="en">
  <head>
    ...
    <title>หน้าแรก | ร้านมาลีวัลย์สังฆภัณฑ์</title>
              ...
              <div class="header-top-right">
                <div class="dropdown">
                  ...
                  >
                    ...
                    <div class="text">
                      <h6 class="user-dropdown-name">เจ้าของร้าน</h6>
          ...
          <nav class="main-navbar">
            <div class="container">
              <ul>
                ...
                <li class="menu-item">
                  <a href="table_stock.php" class="menu-link">
                    <span><i class="bi bi-table"></i> ตารางข้อมูลสินค้า</span>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="insert_product.php" class="menu-link">
                    <span><i class="bi bi-plus-square-fill"></i> เพิ่มข้อมูลสินค้า</span>
                  </a>
                    ...
                    <div class="submenu-group-wrapper">
                      <ul class="submenu-group">
                        <li class="submenu-item">
                          <a
                            href="https://maps.app.goo.gl/Yp9xPE3Ht6fgmuzR7"
                            class="submenu-link"
                            target="_blank"
                            >ที่อยู่ร้าน</a
                          >
            ...
            <div class="container mx-auto">
                <div class="owl-carousel owl-theme owl-loaded owl-drag">
                    ...
                    <div class="owl-item cloned" style="width: 768px; margin-right: 10px;">
                        <a href="#">
                            <img src="assets/images/slide/1.png" alt="งานสัปดาห์วิทยาศาสตร์แห่งชาติ ส่วนภูมิภาค ประจำปี 2566">
                        </a>
                    </div>
                    <div class="owl-item cloned" style="width: 768px; margin-right: 10px;">
                        <a href="#">
                            <img src="assets/images/slide/2.png" alt="อุทยานวิทยาศาตร์และนวัตกรรมสังคม">
                        </a>
                    </div>
