...
<head>
    ...
    $menu = "add_stock";
    ?>
    <title>เพิ่มสต๊อกสินค้า | ร้านมาลีวัลย์สังฆภัณฑ์</title>
    <!-- MDB -->
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">เพิ่มสต็อกสินค้าที่ต้องการ</p>
                        </div>
                                            ...
                                            ?>
                                                ...
                                                <div class="card mx-2 my-2 text-center" style="width: 200px;">
                                                    ...
                                                    <div class="card-footer">
                                                        <button class="btn btn-success" onclick="addToStockAddBox('<?= $result["Product_Name"]; ?>', <?= $result["Product_Qty"]; ?>, <?= $result["Product_ID"]; ?>)">เพิ่มสต็อกสินค้า <i class="bi bi-bag-plus-fill"></i></button>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
                            ...
                            <div class="col-lg-5 pt-5">
                                <div class="row gy-3 mb-4">
                                    <form method="POST" onsubmit="return validateForm();">
                                        ...
                                        <button type="submit" class="btn btn-success w-100 shadow-0 mb-2" id="addStockButton" name="add_stock">เพิ่มสต็อกสินค้า <i class="bi bi-bag-plus-fill"></i></button>
...
if (isset($_POST["add_stock"])) {
    ...
    if ($allUpdatesSuccessful) {
        ...
        $sqlSales = "INSERT INTO sales (Date, Action_Type) 
                        VALUES ('$date', '$actionType')";
        $querySales = mysqli_query($conn, $sqlSales);

        if ($querySales) {
            // Insert data into 'sales_product' table using the generated Sales_ID
            ...
            foreach ($selectedProducts as $productName => $productData) {
                ...
                $sqlSalesProduct = "INSERT INTO sales_product (Sales_ID, Pro_ID, Username, Product_Qty) 
                                        VALUES ('$SalesID', '$productID', '$username', '$quantityToAdd')";
                $querySalesProduct = mysqli_query($conn, $sqlSalesProduct);

                if (!$querySalesProduct) {
