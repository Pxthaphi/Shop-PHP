    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?php if($menu=="table_category"){echo "active";} ?>">
                    <a href="table_category.php" class='sidebar-link'>
                        <i class="bi bi-table"></i>
                        <span>ตารางหมวดหมู่สินค้า</span>
                    </a>
                </li>
                <li class="sidebar-item <?php if($menu=="history"){echo "active";} ?>">
                    <a href="history.php" class='sidebar-link'>
                        <i class="bi bi-clipboard2-fill"></i>
                        <span>ประวัติการทำรายการเพิ่มและตัดสต๊อก</span>
                    </a>
                </li>
