...
<head>
    ...
    $menu = "history";
    ?>
    <title>ประวัติรายการตัดและเพิ่มสต๊อกสินค้า | ร้านมาลีวัลย์สังฆภัณฑ์</title>
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT sales.Sales_ID, sales.Action_Type, sales_product.Username, sales.Date, sales_product.Product_Qty, 
                                            GROUP_CONCAT(product.Product_Name, ' จำนวน ', sales_product.Product_Qty , ' ชิ้น ' SEPARATOR '<br>') AS Product_List
                                            FROM sales_product 
                                            JOIN sales ON sales_product.Sales_ID = sales.Sales_ID 
                                            JOIN product ON sales_product.Pro_ID = product.Product_ID 
                                            GROUP BY sales.Sales_ID, sales.Action_Type, sales_product.Username, sales.Date, sales_product.Product_Qty
